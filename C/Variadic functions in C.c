...
int  sum (int n,...) {
    ...
    va_list lst;        //initialize an variavle list
    va_start(lst,n);    //the variable list and the last named parameter
